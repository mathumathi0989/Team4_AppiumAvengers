...
public class videoPlaySteps {
	...
	@Given("User opens any watched videos")
  	public void user_opens_any_watched_videos() throws Exception {
  		testContext.getTrendingPage().enterSearch("natgeo"); 
...
//  		
//  		try {
//  	  		testContext.getvideoPage().allowmeteredNetworkPopup();
//  	  		
//  	  		}
//  	  		catch (Exception e) {
//  	  			
